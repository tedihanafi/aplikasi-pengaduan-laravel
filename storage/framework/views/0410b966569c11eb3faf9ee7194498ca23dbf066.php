...
<?php $component->withAttributes([]); ?>
        ...
        <div class="mb-4 text-sm text-gray-600">
            <?php echo e(__('lupa kata sandi Anda? Tidak masalah. Beri tahu kami alamat email Anda dan kami akan mengirim email kepada Anda tautan reset kata sandi yang memungkinkan Anda memilih yang baru.')); ?>
...
<?php $component->withAttributes(['class' => ' bg-blue-500 text-white font-bold rounded-md my-3 py-3 px-4 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:bg-blue-500 hover:scale-105 duration-300 ease-in-out']); ?>
                     <?php echo e(__('Tautan Atur Ulang Kata Sandi Email')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\pengaduan-masyarakat\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>